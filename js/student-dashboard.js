...
if (dd == 6 || dd == 0) {
  document.getElementById("lessonSchedule").innerHTML = "<h3>It's weekend! <br> Ensure you do your all assignments and prepare for the week ahead.. <br> Have a wonderful weekend! </h3>"
} else {
...
function showComplaints() {
  ...
  for (i = 0; i < x.length; i++) {
  x[i].classList.remove("gridItem-active");
  x[9].classList.add("gridItem-active");
  }
  paymentHistory.style.display = "none";
  schoolCalendar.style.display = "none";
  myClassmates.style.display = "none";
